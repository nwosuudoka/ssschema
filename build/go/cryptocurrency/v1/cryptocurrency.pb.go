...
type CoinmarketCapQuote struct {
	...
	// Volume24h.
	Volume_24H float64 `protobuf:"fixed64,2,opt,name=volume_24h,json=volume24h,proto3" json:"volume_24h,omitempty"`
	// PercentChange1h
	PercentChange_1H float64 `protobuf:"fixed64,3,opt,name=percent_change_1h,json=percentChange1h,proto3" json:"percent_change_1h,omitempty"`
	// PercentChange24h
	PercentChange_24H float64 `protobuf:"fixed64,4,opt,name=percent_change_24h,json=percentChange24h,proto3" json:"percent_change_24h,omitempty"`
	// PercentChange7d
	PercentChange_7D float64 `protobuf:"fixed64,5,opt,name=percent_change_7d,json=percentChange7d,proto3" json:"percent_change_7d,omitempty"`
	// MarketCap
...
type CoinmarketCapListing struct {
	...
	MaxSupply float64 `protobuf:"fixed64,2,opt,name=max_supply,json=maxSupply,proto3" json:"max_supply,omitempty"`
	...
	CmcRank int32 `protobuf:"varint,4,opt,name=cmc_rank,json=cmcRank,proto3" json:"cmc_rank,omitempty"`
